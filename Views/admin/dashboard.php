    ...
    <div class="container">
                    ...
                    <tbody>
                        <?php foreach ($recentOrders as $order): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/order-detail.php?id=<?php echo $order['order_id']; ?>" class="btn btn-primary btn-small">Xem</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                    ...
                    <tbody>
                        <?php foreach ($lowStock as $product): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/products.php?edit=<?php echo $product['variant_id']; ?>" class="btn btn-primary btn-small">Sửa</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        <div class="admin-menu">
            ...
            <div class="admin-menu-grid">
                <a href="/admin/products.php" class="admin-menu-item">
                ...
                <a href="/admin/customers.php" class="admin-menu-item">
                    <h3>Quản lý khách hàng</h3>
                    <p>Xem thông tin khách hàng</p>
                </a>
                <a href="/admin/inventory.php" class="admin-menu-item">
                    <h3>Quản lý kho</h3>
