...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="<?= BASE_URL ?>admin/couponCreate">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="code" class="form-control form-control-lg text-uppercase" 
                               placeholder="VD: SALE50K" required maxlength="50"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="number" name="discount_value" class="form-control" 
                                   placeholder="10" required min="0" step="0.01" id="discount_value">
                            <span class="input-group-text" id="discount_unit">%</span>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3" id="max_discount_group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" checked style="width: 3em; height: 1.5em;">
                            <label class="form-check-label ms-2" for="is_active">Kích hoạt ngay</label>
                        </div>
                    </div>
                </div>
